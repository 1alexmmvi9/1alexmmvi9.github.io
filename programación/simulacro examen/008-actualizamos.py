class Jugador:                                                                                      #defino una clase
    def _init_(self,nuevoid,nuevonombre,nuevosapellidos,nuevodorsal,nuevoequipo):
...
while True:                                                                                         #añadimos un bucle infinito
    ...
    if opcion == "1":                                                                               #inseramos un registro
        ...
        Jugadores.append(Jugador(identificador,nombre,apellidos,dorsal,equipo))                   #añado la instancia a la lista de clientes
        ...
        clientes[int(idlista)].dorsal = dorsal
        clientes[int(idlista)].equipo = equipo
    elif opcion == "4":
