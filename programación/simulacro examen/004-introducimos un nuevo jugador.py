...
while True:
    ...
    if opcion == "1":
        ...
        identificador = input("Introduce el id del nuevo jugador:")
        nombre = input("Introduce el nombre del nuevo jugador:")
        apellido = input("Introduce el nuevo apellido del jugador:")
        dorsal = input("Introduce el nuevo dorsal del jugador:")
        equipo = input("Introduce el nuevo equipo del jugador:")
        jugador = Jugador(identificador, nombre, apellidos, dorsal, equipo)
